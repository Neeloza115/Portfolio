          ...
          <div className="grid grid-cols-12">
            <div className="col-span-12 p-4">
                <a target="_blank" href="https://github.com/Neeloza115/ShortestPathsAnalyzer/tree/main" className="kill-link-style group">
                  <div
                    className="cards relative cursor-pointer text-left sm:text-center md:text-left duration-200 ease move-up-slightly hover:shadow-xl shadow-md  p-2 md:p-8 sm:p-8 w-full h-auto border-4 rounded-lg overflow-hidden glow-hover glow-hover-small" style={{'--glow-r': 227, '--glow-g': 116, '--glow-b': 0 } as React.CSSProperties}
                  >
                        ...
                        <div className="flex flex-col gap-y-4 md:w-1/2 text-left">
                          ...
                          <div className="flex flex-wrap md:flex-row w-full justify-evenly md:justify-start gap-8 items-center body-text">
                            <div className="relative inline-block group">
                              ...
                              <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-max px-2 py-1   text-sm body-text rounded   pointer-events-none transition-opacity duration-200">
                                Python
                              </div>                    
                            </div>
                            <div className="relative inline-block group">
                            ...
                            <div className="relative inline-block group">
                              ...
                              <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-max px-2 py-1 text-sm rounded body-text   pointer-events-none transition-opacity duration-200">
                                Github
                              </div>                         
                            </div>
                          </div>
            ...
            <div className="col-span-12 p-4">
                <a target="_blank" href="https://github.com/Neeloza115/CollisionDetector" className="kill-link-style group">
                  <div
                    className="cards relative cursor-pointer text-left sm:text-center md:text-left duration-200 ease move-up-slightly hover:shadow-xl shadow-md  p-2 md:p-8 sm:p-8 w-full h-auto border-4 rounded-lg overflow-hidden glow-hover glow-hover-small" style={{ '--glow-r': 244, '--glow-g': 180, '--glow-b': 0 } as React.CSSProperties}
                  >
                    <div className="flex flex-col justify-start w-full gap-y-2 pt-2 pb-4 px-2 md:pt-4 md:px-8 ">
                      <div className="flex flex-row justify-between items-left sm:items-center md:items-center w-full z-40 pointer-events-none">
            ...
            <div className="col-span-12 p-4">
              <a target="_blank" href="https://github.com/Neeloza115/MacEngComp24" className="kill-link-style group">
                  <div className="cards matrix-container relative cursor-pointer text-left sm:text-center md:text-left duration-200 ease move-up-slightly hover:shadow-xl shadow-md  p-2 md:p-8 sm:p-8 w-full h-auto border-4 rounded-lg overflow-hidden glow-hover glow-hover-small"  style={{ '--glow-r': 51, '--glow-g': 184, '--glow-b': 100 } as React.CSSProperties} >
                    <div className="flex flex-col justify-start w-full gap-y-2 pt-2 pb-4 px-2 md:pt-4 md:px-8 ">
                          ...
                          <div className="flex flex-col gap-y-4 md:w-1/2 text-left">
                            ...
                            <div className="flex flex-wrap md:flex-row w-full justify-evenly md:justify-start gap-8 items-center body-text ">
                              <div className="relative inline-block group">
                                ...
                                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-max px-2 py-1 body-text text-sm rounded   pointer-events-none transition-opacity duration-200">
                                  Python
                                </div>                    
                              </div>
            ...
            <div className="col-span-12 p-4">
              <a target="_blank" href="https://moodflix-2d6f5aefae7e.herokuapp.com/moodflix/" className="kill-link-style group">
                  <div
                    className="cards relative cursor-pointer text-left sm:text-center md:text-left duration-200 ease move-up-slightly hover:shadow-xl shadow-md p-2 md:p-8 sm:p-8 w-full h-auto border-4 rounded-lg overflow-hidden glow-hover glow-hover-small"  style={{'--glow-r': 255, '--glow-g': 90, '--glow-b': 90 } as React.CSSProperties} 
                                >
                    <div className="flex flex-col justify-start w-full gap-y-2 pt-2 pb-4 px-2 md:pt-4 md:px-8 ">
                      <div className="flex flex-row justify-between items-center w-full z-40 pointer-events-none">
                          ...
                          <div className="flex flex-col gap-y-5 md:w-1/2 text-left">
                            ...
                            <div className="relative inline-block group">
                              ...
                              <div className="relative inline-block group">
                                ...
                                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-max px-2 py-1 z-50 text-sm body-text rounded   pointer-events-none transition-opacity duration-200">
                                  JavaScript
                                </div>                         
                              </div>
                              <div className="relative inline-block group">
                    ...
                    <div
                      className="movie-rec hidden lg:block md:hidden relative w-full h-[300px] rounded to-white overflow-hidden transition-transform duration-300 ease-in-out"
                      style={{ transform: 'translateY(40px)' }}
                    >
                    </div>
                  </div>
            ...
            <div className="col-span-12 p-4">
              <a target="_blank" href="https://neelsweatherapp-b698fb795223.herokuapp.com" className="kill-link-style group">
                  <div
                    className="cards relative cursor-pointer text-left sm:text-center md:text-left duration-200 ease move-up-slightly hover:shadow-xl shadow-md  p-2 md:p-8 sm:p-8 w-full h-auto border-4 rounded-lg overflow-hidden glow-hover glow-hover-small" style={{'--glow-r': 92, '--glow-g': 136, '--glow-b': 218 } as React.CSSProperties}
                  >
                    <div className="flex flex-col justify-start w-full gap-y-2 pt-2 pb-4 px-2 md:pt-4 md:px-8 ">
                      <div className="flex flex-row justify-between items-center w-full z-40 pointer-events-none">
                          ...
                          <div className="flex flex-col gap-y-5 md:w-1/2 text-left">
                            ...
                            <div className="flex flex-wrap md:flex-row w-full justify-evenly md:justify-start gap-x-10 gap-y-12 items-center body-text">
                              <div className="relative inline-block ">
                                ...
                                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-max px-2 py-1   text-sm rounded   pointer-events-none transition-opacity duration-200">
                                  Python
                                </div>                    
                              </div>
                              <div className="relative inline-block ">
            ...
            <div className="col-span-12 p-4">
              <a target="_blank" href="https://neeloza115.github.io" className="kill-link-style group">
                  <div
                    className="cards relative cursor-pointer text-center md:text-start duration-200 ease move-up-slightly hover:shadow-xl shadow-md  p-2 md:p-8 sm:p-8 w-full h-auto border-4 rounded-lg overflow-hidden glow-hover glow-hover-small group " style={{'--glow-r': 128 , '--glow-g': 128, '--glow-b': 128 } as React.CSSProperties}
                  >
                    <div className="flex flex-col justify-start w-full gap-y-2 pt-2 pb-4 px-2 md:pt-4 md:px-8 ">
                      <div className="flex flex-row justify-between items-center w-full z-40 pointer-events-none">
